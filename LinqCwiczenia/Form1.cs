        ...
        */
        ...
        private void Przyklad1Button_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            var res2 = Emps
                        .Where((emp, index) => emp.Job == "Backend programmer")
                        .Select(emp => new
                        {
                            emp.Ename,
                            emp.Job
        ...
        private void Przyklad4Button_Click(object sender, EventArgs e)
        {
            ...
            var res4 = (from emp in Emps where emp.Salary == max select emp).ToList();

            ResultsDataGridView.DataSource = res4;
        }
        ...
        private void Przyklad5Button_Click(object sender, EventArgs e)
        {
            ...
            ResultsDataGridView.DataSource = res5.ToList();
        }
        ...
        private void Przyklad6Button_Click(object sender, EventArgs e)
        {
            ...
            ResultsDataGridView.DataSource = res6.ToList();
        }
        ...
        private void Przyklad7Button_Click(object sender, EventArgs e)
        {
            ...
            ResultsDataGridView.DataSource = res7.ToList();
        }
        ...
        {
            bool linq = Emps.Any(emp => emp.Job == "Backend programmer");
            if (linq)
            {
        ...
        private void Przyklad10Button_Click(object sender, EventArgs e)
        {
            ...
            var res10 = q1.Union(q2);

            ResultsDataGridView.DataSource = res10.ToList();
        }
